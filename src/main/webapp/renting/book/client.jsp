...
<td class="Form" colspan="3"><tag:IntSelect style="Form" name="adults" min="1" max="9" value="${reservation.adults}" dft="2" readonly="${ro}"/>
<span class="Label">${properties.H_children}:</span><tag:IntSelect style="Form" name="children" min="0" max="9" value="${reservation.children}" dft="0" readonly="${ro}"/>
<span class="Label">${properties.H_infants}:</span><tag:IntSelect style="Form" name="infants" min="0" max="9" value="${reservation.infants}" dft="0" readonly="${ro}"/>
</td>
</tr>
...
<tr><td class="Label">${properties.H_codice}:</td><td class="Form" colspan="3">
<tag:textInput style="Form" name="codice" value="${reservation.codice}" size="30" readonly="${ro}"/>
</td></tr>
